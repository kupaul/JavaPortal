...
public class PolicySearchPortalAPI extends Service {
    ...
    static {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PolicySearchPortalAPI.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8180/pc/ws/search/policySearchPortalAPI?WSDL");
        }
        WSDL_LOCATION = url;
    }
